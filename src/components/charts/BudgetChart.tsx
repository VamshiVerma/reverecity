...
const BudgetChart = ({ 
  ...
  const chartData = data.map(item => {
    // Extract year number from fiscalYear (e.g., "FY2025" -> "2025")
    const year = item.fiscalYear.replace(/FY/i, '');
  ...
  // Custom legend that explains the color coding
  const CustomLegend = () => (
