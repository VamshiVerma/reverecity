...
const InsightsPage = () => {
  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gradient mb-2">Budget Insights</h1>
        <p className="text-gray-400 mb-2">
          Key insights and findings from the city's financial data and statistics
        </p>
        <Card className="mb-4 bg-blue-50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-800">
          <CardContent className="py-3">
            <p className="text-sm font-medium text-blue-800 dark:text-blue-300">
              Note: The approved FY2025 budget totals $274.4 million with nearly 44% dedicated to Revere Public Schools.
            </p>
          </CardContent>
        </Card>
